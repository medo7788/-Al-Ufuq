...
val ParchmentDarkText = Color(0xFF2A2118)
val ParchmentBorder = Color(0xFFE2D5C3)

// Sky Arc Gradient Colors
val SkyDarkNavy = Color(0xFF0B1026)
val SkyMidBlue = Color(0xFF182449)
...
val SunriseGoldStart = Color(0xFF1E284A)
val SunriseGoldEnd = Color(0xFF523B5D)

val DhuhrAzureStart = Color(0xFF15264F)
val DhuhrAzureEnd = Color(0xFF234B7C)

val AsrWarmStart = Color(0xFF1A223D)
val AsrWarmEnd = Color(0xFF4A3E4E)

val MaghribCrimsonStart = Color(0xFF18152E)
val MaghribCrimsonEnd = Color(0xFF5E2E38)

val IshaDeepNavyStart = Color(0xFF0B0E1E)
val IshaDeepNavyEnd = Color(0xFF161C38)
